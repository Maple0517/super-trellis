...
describe("disciplined Trellis runtime templates", () => {
  const markers: [string, string][] = [
    ...
    ["packages/cli/src/templates/common/skills/check.md", "review diff, commit now, or stop local"],
    ["packages/cli/src/templates/common/skills/check.md", "If no active task exists and the user did not explicitly opt into no-task review, stop"],
    ...
    ["packages/cli/src/templates/common/skills/brainstorm.md", "No-task mode"],
    ["packages/cli/src/templates/common/skills/brainstorm.md", "Do not create or update `prd.md`"],
    ...
    ["packages/cli/src/templates/trellis/workflow.md", "No active task does not mean skip Trellis discipline."],
    ["packages/cli/src/templates/trellis/workflow.md", "Milestone Handoff Discipline"],
    ["packages/cli/src/templates/trellis/workflow.md", "Verification passed + intended work still uncommitted"],
    ...
    ["packages/cli/src/templates/common/skills/before-dev.md", "If no active task exists and the user did not explicitly opt into no-task work, stop"],
    ["packages/cli/src/templates/common/skills/update-spec.md", "No-task approval gate"],
