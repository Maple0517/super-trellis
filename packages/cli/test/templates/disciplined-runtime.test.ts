...
describe("disciplined Trellis runtime templates", () => {
  const markers: Array<[string, string]> = [
    ...
    ["packages/cli/src/templates/common/skills/check.md", "If no active task exists, use the current user request"],
    ...
    ["packages/cli/src/templates/common/skills/before-dev.md", "If no active task exists, use the current user request"],
