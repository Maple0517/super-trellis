...
name: check
description: |
  Code quality auditor for the Trellis channel runtime. Reviews uncommitted diffs against task artifacts and specs, self-fixes mechanical issues only, and reports verification results.
provider: claude
